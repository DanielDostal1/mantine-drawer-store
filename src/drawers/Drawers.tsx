...
import { BlueFormDrawer } from "./formDrawers/BlueFormDrawer";
import { GreenDrawer } from "./GreenDrawer";
import { GreenFormDrawer } from "./formDrawers/GreenFormDrawer";
import { RedDrawer } from "./RedDrawer";
import { RedFormDrawer } from "./formDrawers/RedFormDrawer";

export const Drawers = () => {
  const { drawers, closeDrawer, formDrawers, closeFormDrawer } =
    useDrawerStore();
